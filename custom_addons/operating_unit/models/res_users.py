...
class ResUsers(models.Model):
    ...
    partner_ids = fields.Many2many('res.partner', 'res_op_rel')
    ...
    def _onchange(self):
        return {'domain': {'operating_unit_ids': [('company_id', 'in', self.company_ids.ids)],
                           'default_operating_unit_ids': [('company_id', 'in', self.company_ids.ids)]}}
